...
$response=array();
    ...
    // $currentOnlineUserId=$_POST['currentOnlineUserId'];   user_id='$currentOnlineUserId' AND

    $selQuery="SELECT * FROM orders_table WHERE status='new' ORDER BY dateTime DESC";
